...
Several items previously listed as conjectured have been proved since the initial submission: core depth from energy minimization (H2', deep core existence), transport fixed-point existence (Schauder, any $\varepsilon_{\mathrm{OT}} > 0$), and the full phase transition (T8-Full, conditional on generic non-degeneracy, which holds generically by Sard's theorem). What remains genuinely conjectured:
...
\item \textbf{C3'' symmetrization gap.} The co-belonging axiom requires a symmetrization step whose gap is ``highly plausible'' but unproved. This is a first-order structural issue for the axiomatic foundations.
...
The companion mathematical paper establishes 25 fully proved theorems, 6 structural results (including the newly proved T-Bind), and 6 conditional results with standard hypotheses, for a total of 43 formal claims at 88\% proved or conditional. Multi-formation theory is proved in two regimes (well-separated and weakly interacting), with the isoperimetric energy ordering establishing that formation splitting is always energetically unfavorable.
