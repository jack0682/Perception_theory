...
\item \textbf{Merge dynamics.} A mountain pass theorem establishes finite energy barriers $\Delta E \leq \Theta(\beta)$ between multi-formation configurations, with Kramers merge rate $\tau \sim \exp(\Delta E/\sigma^2)$. $K$-formation metastability is proved (local minimum, never saddle).
...
The companion mathematical paper establishes 41 fully proved theorems (Category~A), 3 structural results (Category~B), and 4 conditional results (Category~C) with standard hypotheses, for a total of 48 formal claims at 92\% proved or conditional. Multi-formation theory is proved in two regimes (well-separated and weakly interacting), with the isoperimetric energy ordering establishing that formation splitting is always energetically unfavorable.
