...
**Cross-references:** All terms link to formal registries (D-xxxx, S-xxxx, A-xxxx) via [link](concept_registry.md)

---

See also: **ontology.md** (conceptual hierarchy), **concept_registry.md** (formal definitions), **symbol_registry.md** (notation key)
