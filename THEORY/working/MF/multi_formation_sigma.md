...
- $[\rho_k]$ is the irrep of the $k$-th eigenvector under the wreath-product $G_{\mathbf{u}}$ representation. **This is the structurally new ingredient**: irreps of wreath products are well-studied (Specht 1933, James-Kerber 1981); they have a hierarchical structure $[\rho_k] = ([\rho_{\text{outer}}] \otimes \{[\rho_{\text{inner},j}]\}_j)$.
