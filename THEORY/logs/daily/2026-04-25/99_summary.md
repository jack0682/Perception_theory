...
- `THEORY/2_substrate/canonical/theorem_status.md`: F-1 → SPLIT-RESOLVED, M-1 → LAYER-CLARIFIED 수정
- `THEORY/2_substrate/canonical/canonical.md §13`: Theorem 2 (T-PreObj-1) Cat A entry 추가
