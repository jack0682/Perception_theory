...
- **`THEORY/2_substrate/canonical/canonical.md`** — 특히 §3 (formal universe), §6 (axiom groups A-E), §8 (energy), §11 (fixed commitments & open design choices), §12 (open problems), §13 (49 claims registry), §14 (CN1–CN14 commitment notes).
- **`THEORY/2_substrate/canonical/theorem_status.md`** — 49 claims 현재 Category (35 A / 4 B / 5 C / 5 Retracted) 및 각각의 소스 (canonical §13 참조).
- **`THEORY/2_substrate/canonical/theorem_status.md`** — 기존 OP-0001 ~ OP-0007. 각 후보가 어떤 OP 를 건드리는지 대응 필요.
