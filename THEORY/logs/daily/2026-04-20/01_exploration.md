...
**Depends on reading:** `THEORY/logs/daily/2026-04-20/plan.md`; `THEORY/working/reformulation_plan.md` §Stage 0; `THEORY/working/open_problems_reframing_2026-04-19.md` §1–§9; `THEORY/2_substrate/canonical/canonical.md` §3, §6, §8, §11, §12, §13, §14 (CN1–14); `THEORY/2_substrate/canonical/theorem_status.md` OP-0001~0007; `THEORY/2_substrate/canonical/theorem_status.md` 전체.
